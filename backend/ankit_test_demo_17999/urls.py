"""ankit_test_demo_17999 URL Configuration
...
admin.site.site_header = "Ankit Test Demo"
admin.site.site_title = "Ankit Test Demo Admin Portal"
admin.site.index_title = "Ankit Test Demo Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="Ankit Test Demo API",
        default_version="v1",
        description="API documentation for Ankit Test Demo App",
    ),
    public=True,
